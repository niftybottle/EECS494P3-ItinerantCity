...
public class TiledXMLReader : MonoBehaviour 
{
    ...
    Attach this script to a gameobject. Next, using the Tiled Editor (free doownload available at http://www.mapeditor.org/) build a map. Follow the documentation on
    ...
    Finally, click play to see your map and create your new scene. 
